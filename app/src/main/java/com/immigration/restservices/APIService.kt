...
import com.immigration.appdata.Constant.urlQuestions
...
import com.immigration.appdata.Constant.urlStatisticReport
import com.immigration.appdata.Constant.urlUpdateProfile
import com.immigration.appdata.Constant.urlVerifyOtp
import com.immigration.appdata.Constant.urlgetPdfs
...
interface APIService {
    ...
    @GET(urlStatisticReport)
    fun getStatisticReport(@Header ("accessToken") accessToken:String): Call<Model_Statistic>


    @FormUrlEncoded
    @POST(urlQuestions)
    fun getQuestions(@Field("immigrationId") immigrationId:String,
                     @Field("questionId") questionId:String,
                     @Field("answerId") answerId:String
    ):Call<QuestionModel>


    @FormUrlEncoded
    @POST(urlgetPdfs)
    fun getPdfs(@Field("immigrationId") name:String):Call<Model_Statistic>
