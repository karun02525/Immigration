...
public class LoginPrefences {
    ...
    private static final String PRE_NAME = "login_gmc";

    private static final String PRE_AccessToken= "accessToken";
    private static final String PRE_UserId= "userId";
    private static final String PRE_CountryCode= "countryCode";
    private static final String PRE_Mobile = "mobile";

    private static final String PRE_pass = "pass";
    private static final String PRE_Email = "email";
    private static final String PRE_Fname = "fname";
    private static final String PRE_Lname = "lname";
    private static final String PRE_ProfilePic = "profilePic";
    ...
    public boolean hasValue(SharedPreferences preferences) {
        return (preferences.getString(PRE_Mobile, "").equalsIgnoreCase("")) && preferences.getString(PRE_pass, "").equalsIgnoreCase("");
    }
